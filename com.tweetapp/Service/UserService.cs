...
namespace com.tweetapp.Service
{
    public class UserService : IUserService
    {
        ...
        public UserService(ITweetRepository repo)
        {
...

        {
            ...
            Console.WriteLine(string.Format("{0,-10}|{1,10}", "1.Create New Account  ", "2. Login"));
            Console.WriteLine(string.Format("{0,-10}|{1,10}", "3.Forget Password  ", "4. Reset Password"));
        ...
        public bool UserRegistration()
        {
            ...
            User registrationData = new User();
        ...
        public bool Logout()
        {
            return this.repository.Logout(currentUser);
        }
